...
public class log extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(568, 0, -1, 475));

        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\LENOVO\\Desktop\\okk.png")); // NOI18N
        jPanel3.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(49, 39, 443, 359));
        ...
        jPanel3.add(BACKBTN1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 376, 570, 60));
        ...
        jPanel3.add(BACKBTN2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 376, 570, 60));

        jLabel8.setFont(new java.awt.Font("Segoe UI", 0, 32)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(102, 0, 102));
        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel8.setText("LOGIN AS AN EMPLOYEE");
    ...
    private void LOGINBTNMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_LOGINBTNMouseClicked
        ...
        {
            String query = "select * from employee where accnum = ? and password = ?";
            try{ 
                ...
                if(Rs.next())
                {
                    new MainMenu(Rs.getInt(3),1).setVisible(true);
                    this.dispose();
                }
                else
                {
